...
@Composable
fun BukaRekeningBerhasilScreen(
    onMulaiClick: () -> Unit = {}
) {
    Column(
        modifier = Modifier
        ...
        Box(
            modifier = Modifier
                .fillMaxWidth()
                .height(60.dp)
                .background(Color.White), // sama dengan bg_appbar
...
@Preview
@Composable
fun PreviewBukaRekeningBerhasil() {
    BukaRekeningBerhasilScreen()
}
