                ...
                modifier = Modifier
                    ...
                    .background(
                        Brush.linearGradient(
                            colors = listOf(
                                Color(0xFF4A68FF), // startColor dengan alpha
                                Color(0xFF4A68FF), // centerColor
                                Color(0xB8A1BAE0)  // endColor
                            ),
                            start = Offset(0f, 0f),
            ...
            Box(
                modifier = Modifier
                    ...
                    .background(
                        Brush.linearGradient(
                            colors = listOf(
                                Color(0xff878A87).copy(alpha = 0f), // transparan (tidak nutup)
                                Color(0xFF8A1BAE0).copy(alpha = 0.6f) // makin gelap
                            ),
                            start = Offset.Zero,            // kiri-atas
                            end = Offset.Infinite           // bawah-kanan
                        ),
                        alpha = 1f // full opacity, tapi sudah ada gradient alpha
                    )
            )
...
//            )
            AsyncImage(
                model = Res.getUri("files/mask_card.svg"),
                contentDescription = null,
                modifier = Modifier
                    .fillMaxHeight()
                    .align(Alignment.BottomEnd)
            ...
            Column(
                ...
                Text("Total Tabungan", fontSize = 14.sp, color = Color.White)
                Text(
                    "Rp1.509.000",
                    fontSize = 24.sp,
