        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (result.isSuccess) {
                    ...
                    _errorMessage.value = result.exceptionOrNull()?.message ?: "Failed to load promotions"
                }
            } catch (e: Exception) {
                _errorMessage.value = e.message ?: "Failed to load promotions"
            } finally {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (result.isSuccess) {
                    ...
                    _errorMessage.value = result.exceptionOrNull()?.message ?: "Failed to load promotion detail"
                }
            } catch (e: Exception) {
                _errorMessage.value = e.message ?: "Failed to load promotion detail"
            } finally {
                _isLoading.value = false
            }
        }
